(ns masr.resources._pass_loop_vectorise-vec_01-fdf30b1.Function.Function_90522)
...
#:masr.specs{:term :masr.specs/symbol,
             ...
             #:masr.specs{:symbol-head :masr.specs/Function,
                          ...
                          :dependencies [],
                          :deterministic false,
                          :function-signature "FunctionType_90090",
                          :side-effect-free false,
                          :access
                          #:masr.specs{:term :masr.specs/access,
                                       :access-enum "Public"},
                          :return-var? "Var_89160",
                          :param* ["Var_89157"],
                          :SymbolTable
