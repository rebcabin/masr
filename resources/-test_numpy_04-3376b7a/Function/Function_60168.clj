(ns masr.resources.-test_numpy_04-3376b7a.Function.Function_60168)
...
#:masr.specs{:term :masr.specs/symbol,
             ...
             #:masr.specs{:symbol-head :masr.specs/Function,
                          ...
                          :dependencies [],
                          :deterministic false,
                          :function-signature "FunctionType_59733",
                          :side-effect-free false,
                          :access
                          #:masr.specs{:term :masr.specs/access,
                                       :access-enum "Public"},
                          :return-var? "Var_58926",
                          :param* ["Var_58923"],
                          :SymbolTable
                          #:masr.specs{:term :masr.specs/SymbolTable,
                                       ...
                                       {:_lpython_return_variable
                                        "Variable_59466",
                                        :x "Variable_59469"}},
                          :function-name "_lfortran_sacosh"}}
