                        ...
                        192
                        {
                            ...
                            :accept_multidim_i32_array
                                (Function
                                    ...
                                    [(Var 185 xi32)]
                                    [(=
                                        (Var 185 _lpython_return_variable)
                                        (ArrayItem
                                            (Var 185 xi32)
                                            [(()
                                            (IntegerConstant 0 (Integer 4 []))
