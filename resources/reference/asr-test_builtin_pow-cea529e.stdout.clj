                                ...
                                (Function
                                    ...
                                    (=
                                        ...
                                        (Cast
                                            (RealBinOp
                                                (Cast
                                                    (IntegerConstant 525346 (Integer 4 []))
                                                    IntegerToReal
                                                    (Real 8 [])
                                                    (RealConstant
                                                        525346.000000
                                                ...
                                                Div
                                                (Cast
                                                    (IntegerConstant 66456 (Integer 4 []))
                                                    IntegerToReal
                                                    (Real 8 [])
                                                    (RealConstant
                                                        66456.000000
                                            ...
                                            (IntrinsicFunction
                                                ...
                                                [(RealBinOp
                                                    (FunctionCall
                                                        ...
                                                        (Real 8 [])
                                                        (RealConstant
                                                            394800380598526378720936476336799774273305305904443955996320177992404102454228192853661558132283280490733920647962082901303487965679010854404517306573035287122910924343151116372519789002752.000000
                                                            (Real 8 [])
                                                        )
                                                        ()
                                                    )
