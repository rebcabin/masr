...
int64_t __lpython_overloaded_4___mod(int64_t a, int64_t b);
float __lpython_overloaded_4__pow(int32_t x, float y);
int64_t __lpython_overloaded_5___lpython_floordiv(int64_t a, int64_t b);
...
{
    int64_t _lpython_return_variable;
    _lpython_return_variable = a - __lpython_overloaded_5___lpython_floordiv(a, b)*b;
    return _lpython_return_variable;
}
...
int64_t __lpython_overloaded_11__pow(int64_t x, int64_t y, int64_t z)
{
    ...
    result = __lpython_overloaded_4___mod(:std:pow(x, y), z);
    _lpython_return_variable = result;
    return _lpython_return_variable;
}
