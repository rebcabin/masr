...
=dimensions=, =identifier=, =identifiers=. Note
carefully the singulars and plurals in the names of
the specs.
...
sugar/ and /full sugar/. Light sugar require specs
with keywords, as in:
...
([[dimensions]]) of the ttype is =[42]=, and the ttype
...
ttype is =[6 60]=, and the ttype specifies a rank-1
...
See Issue 6 in MASR's GitHub repo[fn::
https://github.com/rebcabin/masr/issues/6] for
discussion of the meaning of \linebreak
=(Integer 4 [[]])=. Empty dimensions [\emph{sic}] as
in =(Integer 4 [])=, are discussed in Section
[[dimensions]].
...
See Issue 7 in MASR's GitHub repo.[fn::
