...
Set of =Local=, =In=, =Out=, =InOut=, =ReturnVar=, =Unspecified=.

Records seem fundamentally incompatible with entity maps
clojure.spec.[fn:: https://clojure.org/guides/spec] Entity maps
are more important, so we're going that way.[fn::
https://stackoverflow.com/questions/48366052/is-it-possible-to-use-namespaced-keywords-with-records]


\vskip 0.26cm
#+begin_src clojure :eval never
  (defrecord intent
      [masr.intent/intent-sym])
