...
The specs for /atoms/ are unsurprising:
...
We restrict the spec for natural numbers to /int/
...
in Clojure must have explicit minus signs. To access
the underlying =java.lang.Long=, one must employ
Clojure's =unchecked-long=.
