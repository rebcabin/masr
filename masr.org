...
Every example has a full form as well as a sugared
form. Sugared forms are shorter for common cases and
thus recommended much of the time.
...
#+label: {tbl:non-nestes-specs}
| **Spec or Multi-Spec** | **Sugared Conforming Example**     |
|------------------------+------------------------------------|
| =::nat=                | =(nat 42))=                        |
...
| =::symbol= | =::Variable= | =(Variable :symtab-id 42 ...)= |
