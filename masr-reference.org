...
specs.[fn:summary: See the companion document,
=masr.summary.pdf=.]
...
specs.[fn:summary] There are about 250 heads by a
recent count.
...
/term-entity-key spec/ for any enum-like.[fn:summary]
...
sugar.[fn:summary] Note the term-head-entity-key
spec,.[fn:summary] =::Variable= . Any =::Variable=
is also an =::asr-term=.
...
term-entity-key spec,[fn:summary], =::storage-type=:
...
=::asr-term= and the term-entity-key spec,[fn:summary] =::access=.
...
Presence is another enum-like, defined and
registered via macro (Section [[enum-like-macro]]). The
following tests of heavy sugar illustrate
conformance to both =::asr-term= and the
term-entity-key spec,[fn:summary] =::presence=.
...
Here is its term-entity key,[fn:summary] =::abi=,
...
sugar/ and /heavy sugar/.[fn:summary]
...
term-entity-key spec[fn:summary] for /dimension/:
